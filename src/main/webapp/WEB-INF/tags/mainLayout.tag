...
<body>
 <div class="container">
  <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
   <a href="<c:url value="/"/>" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
 ...
 <div class="container">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
   ...
   <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
    <li class="ms-3"><a class="text-muted" href="#"><img src="<c:url value="/img/vk-logo.png"/>" alt="vk" width="32" height="32"></a></li>
    <li class="ms-3"><a class="text-muted" href="#"><img src="<c:url value="/img/tg-logo.png"/>" alt="tg" width="32" height="32"></a></li>
    <li class="ms-3"><a class="text-muted" href="#"><img src="<c:url value="/img/insta-logo.png"/>" alt="insta" width="32" height="32"></a></li>
   </ul>
  </footer>
 </div>
</body>
